                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8 mx-auto col-12">
                            ...
                            <h1 class="hero-title text-center mb-5">Patient<span>Registration</span></h1>
                            ...
                            <div class="row">
                                <div class="col-lg-8 col-11 mx-auto">
                                  <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                        ...
                                        <div class="form-floating">
                                            <input type="text" name="" id="" class="form-control"placeholder="Patient First Name" required>
                                        ...
                                        <div class="form-floating">
                                            <input type="date" name="" id="" class="form-control"placeholder="Patient Date of Birth" required>
                                            <span class="invalid-feedback"></span>
                                            <label for="date_of_birth">Patient Date of Birth</label>
                                        </div><br>

                                        <div class="form-floating">
                                            <input type="number" name="" id="" class="form-control"placeholder="Patient Contact No" required>
                                            <span class="invalid-feedback"></span>
                                        ...
                                        <div class="form-floating">
                                            <input type="text" name="" id="" class="form-control" placeholder="Patient Complete Address" required>
                                            <span class="invalid-feedback"></span>
