...
function pr($t){echo'<pre>';print_r($t);echo'</pre>';} 
                        while($row = mysqli_fetch_assoc($query_run)){
		      							...
		      							<tr>
											  ...
											  <td>'.$row["dob"].'</td>
											  <td>'.$row["gender"].'</td>
		      							 <td><button type="button" name="patient" class="btn btn-primary btn-sm p-3 patient" data-id="'.$row["id"].'">Edit</button></td>
		      							</tr>
		      							';
		      						}
		      						?>
...
<div id="patientModal" class="modal fade">
  	<div class="modal-dialog">
    	<form action="includes/edit_patient.inc.php" method="post" id="appointment_form">
